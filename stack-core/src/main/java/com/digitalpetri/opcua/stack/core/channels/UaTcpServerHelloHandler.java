...
import com.digitalpetri.opcua.stack.core.channels.messages.AcknowledgeMessage;
import com.digitalpetri.opcua.stack.core.channels.messages.HelloMessage;
import com.digitalpetri.opcua.stack.core.channels.messages.MessageType;
import com.digitalpetri.opcua.stack.core.channels.messages.TcpMessageDecoder;
...
public class UaTcpServerHelloHandler extends ByteToMessageDecoder implements HeaderDecoder {
    ...
    private void onHello(ChannelHandlerContext ctx, ByteBuf buffer) throws UaException {
        ...
        SerializationQueue serializationQueue = new SerializationQueue(parameters);
