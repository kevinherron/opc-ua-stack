...
public class UaTcpClient {
    ...
    public UaTcpClient(ApplicationDescription application,
        ...
        ByteString clientNonce = secureChannel.isSymmetricSigningEnabled() ?
                generateNonce(getNonceLength(secureChannel.getSecurityPolicy().getSymmetricEncryptionAlgorithm())) :
    ...
    public void sendRequests(List<? extends UaRequestMessage> requests,
        ...
        checkArgument(requests.size() == futures.size(), "requests and futures parameters must be same size");
